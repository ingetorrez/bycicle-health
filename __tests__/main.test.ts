...
describe('AppointmentAvailability', () => {
  ...
  it('Correctly returns availability without booked appointment and calendar event', async () => {
    const deps: AppointmentAvailabilityDeps = {
      getCalendarEvents: async (providerId: string, start: Date, end: Date) => {
        return [];
      },
    ...
    const appointmentAvailability = new AppointmentAvailability(deps);
    const start = new Date('2022-06-14T08:00:00.000Z');
    const end = new Date('2022-06-14T17:00:00.000Z');
    ...
    const expectedResult: TimeRange[] = [
      {        
        start: new Date('2022-06-14T08:00:00.000Z'),
        end: new Date('2022-06-14T17:00:00.000Z'),
      },
    ];
